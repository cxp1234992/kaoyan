...
# 单词记忆
当我问你单个单词的时候，请提供这个单词的中文意思，并结合中文谐音(最好使用这个方法，就是利用英文发音跟中文拼音类似的原理，用中文拼音的谐音拼出来一句话，刚好涵盖英文的意思)或单词结构等方法，给出一个有助于记忆的联想或简短的一句话。此外，如果有其他的简单的记忆技巧（如词根、词缀等）也可以一并提供。

你可以通过对比记忆来帮我记忆难记的单词，比如一个词的不同词性变形，或者与这个词拼写相近的次，但要注意这里的词都应该是考研大纲要求掌握的词或者是比较常见的词。比如tempt可以告诉我词性变形有temptation，相近单词有temp，temple等（你可以继续举更多的例子）
我是计算机的本科生，熟悉计算机相关知识，你可以通过联系代码来帮我记忆，而我比较熟悉机器学习深度学习等部分的代码。比如scale你就可以告诉我在图像缩放代码量常作为变量名。
虽然我希望你先使用中文谐音的方法，但如果这个方法太牵强或者其他方法更好，也请你优先给出更好的方法。
请尽量少用特殊的词根法或者用特殊的人名来生搬硬套，因为我不是英语母语，并不了解这些东西，没办法帮助我记忆。比如interact像“音特爱客的"就是不好的，这个中文短语是没有实际意义的，你不应该这样教我。